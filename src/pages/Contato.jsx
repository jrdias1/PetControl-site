      ...
      <section className="py-20">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <a
              href="https://wa.me/5524981375213?text=Olá! Acabei de solicitar uma demo do EssencialPet"
              target="_blank"
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="bg-gray-50 rounded-2xl p-6 space-y-4">
              ...
              <a 
                href="https://wa.me/5524981375213"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">(24) 98137-5213</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">essencialcomunicacaoeinfo@gmail.com</div>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Petrópolis – RJ, Brasil 🇧🇷</div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">@essencial_comunicacao</div>
                </div>
              </a>
            </div>
          </motion.div>
